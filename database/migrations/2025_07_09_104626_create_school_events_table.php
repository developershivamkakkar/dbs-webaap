...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('school_events', function (Blueprint $table) {
            ...
            $table->date('published_date'); // Explicit field for the Event publication date.
            $table->enum('status', ['draft', 'published', 'archived'])->default('draft'); // Better categorization of Event status.
