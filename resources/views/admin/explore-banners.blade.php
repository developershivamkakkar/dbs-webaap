    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Explore Banners</h1>
                        <span class="font-size:10px; ">Banner-Size: 2436 X 1206 in pixels</span>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('explore-upload.banner') }}">Add Banner</a></li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ route('explore-banner.upload') }}" class="btn btn-primary btn"><i
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form class="d-inline" method="POST"
                                                            action="{{ route('explore-banner.delete', ['id' => $banner->id]) }}">
                                                            @csrf
                                                            @method('DELETE')
